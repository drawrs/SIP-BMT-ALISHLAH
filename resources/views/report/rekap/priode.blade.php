  ...
  <thead>
                    ...
                    @foreach ($rekap as $data_rekap)
                      ...
                      <tr bgcolor=white>
                                  ...
                                  <td></td>
                                  <td><b>TOTAL</b></td>
                                  <td ><b><u>{{rupiah($t_gapok)}}</u></b></td>
                                  <td><b><u>{{rupiah($t_tunjab)}}</u></b></td>
                                  <td><b><u>{{rupiah($t_transport)}}</u></b></td>
                                  <td><b><u>{{rupiah($t_um)}}</u></b></td>
                                  <td><b><u>{{rupiah($t_tunkel)}}</u></b></td>
                                  <td><b><u>{{rupiah($t_jml_gaji)}}</u></b></td>
                                  <td><b><u>{{rupiah($t_kasbon)}}</u></b></td>
                                  <td><b><u>{{rupiah($t_angs)}}</u></b></td>
                                  <td><b><u>{{rupiah($t_simwa)}}</u></b></td>
                                  <td><b><u>{{rupiah($t_bpjs)}}</u></b></td>
                                  <td><b><u>{{rupiah($t_arisan)}}</u></b></td>
                                  <td><b><u>{{rupiah($t_lainnya)}}</u></b></td>
                                  <td><b><u>{{rupiah($t_zis)}}</u></b></td>
                                  <td><b><u>{{rupiah($t_jml_pot)}}</u></b></td>
                                  <td><b><u>{{rupiah($t_jml_terima)}}</u></b></td>
                                </tr>
