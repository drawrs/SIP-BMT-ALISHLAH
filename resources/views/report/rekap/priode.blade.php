...
<head>
  ...
  <title>REKAP GAJI PRIODE : {{$tgl_awal}} - {{$tgl_akhir}} | CABANG : {{$cabang_name}}</title>
  <style type="text/css">
    #logo {
     width: 300px;
     height: 200px; 
  ...
  <center>
    <table id="contoh1" class="display">
      ...
      <tbody>
        ...
        ?>
        @else
        {{-- Perhitungan jika satu cabang--}}
        @if ($cabang_user == $cab_id) 
            <?php
            $t_gapok += $data_rekap->gaji_pokok;
            $t_tunjab += $data_rekap->tunjab;
            $t_transport += $data_rekap->uang_transport;
        ...
        @endif
        @if($cab_id == 'all')
            @include('includes.priode-rekap-gaji')
        @else
          @if ($cabang_user == $cab_id) 
            @include('includes.priode-rekap-gaji')
          @endif
        ...
        <tr bgcolor=white>
          ...
          <td></td>
          <td><b>TOTAL</b></td>
          <td class="curr"><b><u>{{rupiah($t_gapok)}}</u></b></td>
          <td class="curr"><b><u>{{rupiah($t_tunjab)}}</u></b></td>
          <td class="curr"><b><u>{{rupiah($t_transport)}}</u></b></td>
          <td class="curr"><b><u>{{rupiah($t_um)}}</u></b></td>
          <td class="curr"><b><u>{{rupiah($t_tunkel)}}</u></b></td>
          <td class="curr"><b><u>{{rupiah($t_pensiun)}}</u></b></td>
          <td class="curr"><b><u>{{rupiah($t_bpjs_kes)}}</u></b></td>
          <td class="curr"><b><u>{{rupiah($t_bpjs_tk)}}</u></b></td>
          ...
          <td class="curr"><b><u>{{rupiah($t_lainnya)}}</u></b></td>
          <td class="curr"><b><u>{{rupiah($t_zis)}}</u></b></td>
          <td class="curr"><b><u>{{rupiah($t_jml_pot)}}</u></b></td>
          <td class="curr"><b><u>{{rupiah($t_jml_terima)}}</u></b></td>
        </tr>
    ...
    <table id="contoh2" class="display" width="50%">
      <thead>
        ...
        <tbody>
          ...
          @include('includes.priode-rekap-gaji-lainnya')
          @else
          {{-- Jika cabang_id user == cabang id--}}
          @if($cabang_user == $cab_id)
          @include('includes.priode-rekap-gaji-lainnya')
          @endif
          @endif
