...
if (! function_exists('hitung_zis')) {
    
    function hitung_zis($n_gaji, $n_zis = 2.5, $percent = 100)
    {
        $result = ($n_gaji*$n_zis)/$percent;
        return $result;
    }

}
if (! function_exists('hitung_gatot')) {
    
    function hitung_gatot($gaji_pokok = 0,  $tunjab = 0, $uang_transport = 0, $uang_makan = 0, $tunkel = 0)
    {
        $result = $gaji_pokok + $tunjab + $uang_transport + $uang_makan + $tunkel;
        return $result;
    }

}
if (! function_exists('diff_hm')) {
    
    function diff_hm($date, $in, $out)
    {
        $to = Carbon::parse("$date $in");
        $from = Carbon::parse("$date $out");

        $result = $to->diff($from); // DateInterval obje
...
if (! function_exists('toDate')) {
     ...
     * @return \Illuminate\View\View|\Illuminate\Contracts\View\Factory
     */
    function toDate($date = '0000-00-00')
    {
        $tgl = explode('-', $date);
