        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <div class="box-body table-responsive">
              <form class="form-horizontal" role="form" method="POST" action="<?php echo e(route('karyawan.master-post')); ?>">
...
<?php echo $__env->make('layouts.masbar-master', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>