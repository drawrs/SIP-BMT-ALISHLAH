...
<head>
  ...
  <title><?php echo $__env->yieldContent('title'); ?>Masukan PIN | BMT Al-Ishlah</title>
  <link href="<?php echo e(URL::to('/icon/favicon.ico')); ?>" rel="shortcut icon">
    ...
    <div class="lockscreen-wrapper">
      ...
      <div class="lockscreen-item">
        ...
        <div class="lockscreen-image">
          <img src="<?php echo e(URL::to('upload/foto_pegawai/user.png')); ?>" alt="User Image">
        </div>
        <!-- /.lockscreen-image -->

        <!-- lockscreen credentials (contains the form) -->
        <form class="lockscreen-credentials" action="<?php echo e(route('gaji')); ?>" method="POST">
