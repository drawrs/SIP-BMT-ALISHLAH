            ...
            <div class="box-body table-responsive">
              <table id="example" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>
                    <ul>
                    <?php /* mencegah karyawan yg datanya ngga ada */ ?>
                      <li>NAMA PEGAWAI : <b><a href="<?php echo e(route('karyawan.edit', ['edit' => $data->user_id])); ?>"><?php echo count($data->user) > 0 ? $data->user->detail->nama: "<small><i>(data pegawai tidak valid)</i></small>"; ?></a></b></li>
                      <li><b><?php echo e(count($data->user) > 0 ? $data->user->cabang->name: ""); ?></b></li>
                    </ul>
                  </td>
